...
const Banner = () => {
  ...
  return (
    <div className='grid grid-cols-2  text-white h-full pt-10'>
      <div className='flex flex-col mt-32 ml-24'>
          ...
          <button onClick={()=>navigateTo('/booking')} className='bg-yellow-400 rounded-lg mt-10 w-1/2 text-gray-400 font-semibold cursor-pointer active:bg-yellow-500 hover:bg-yellow-500 hover:text-gray-200' >Book A Table</button>
      </div>
